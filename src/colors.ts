...
export const gradientBgPurplePink = `${gradientBgBase} from-indigo-950 via-indigo-700 to-indigo-500`;
...
export const getButtonColor = (color: ColorButtonKey, isOutlined: boolean, hasHover: boolean, isActive = false) => {
  ...
  const colors = {
    ...
    borders: {
      ...
      info: 'border-indigo-900 dark:border-indigo-900',
    },
    text: {
      ...
      info: 'text-indigo-900 dark:text-indigo-900',
    },
    outlineHover: {
