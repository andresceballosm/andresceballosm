...
const listItems = [
  {
    title: 'Creators',
    description: `Know the level of acceptance of your posts by your followers, 
    respond to the comments of your followers on different social networks from a single app.`,
  },
  {
    title: 'Bussiness',
    description: `Know the level of acceptance of your products and services by your customers, 
    and respond to the comments of your customers on different social networks from a single app.`,
  },
  // {
