...
const InstagramProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const connectInstagram = async (accessToken: string, tokenValue: string, updateAccountConnected: any) => {
    ...
    try {
      ...
      // eslint-disable-next-line no-console
      console.log('request connect==== ', request);
      if (request.data.ok) {
        ...
        // Alert.alert(
        //   `Alert`,
        //   request.data.response.msg?.message ? request.data.response.msg?.message : request.data.response.msg,
        // );
        // Alert.alert(
        //   request.data.response.msg?.message
        //     ? request.data.response.msg?.message
        //     : request.data.response.msg,
        // );
